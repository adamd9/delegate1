...
class VoiceClient {
    ...
    async initializeDevice() {
        ...
        try {
            ...
            if (!accessToken) {
                this.log('❌ Backend did not return an access token', 'error');
                this.log('💡 Check backend logs for token generation errors', 'info');
                this.updateStatus('Token Generation Failed', 'disconnected');
                this.connectBtn.disabled = false;
                return;
            }
            
            this.log(`✅ Received fresh access token from backend`, 'success');
            this.log(`🔍 Debug: Token length: ${accessToken.length}`, 'info');
            this.log(`🔍 Debug: Token starts with: ${accessToken.substring(0, 20)}...`, 'info');
            this.log(`🔍 Debug: Client identity: ${data.identity}`, 'info');
